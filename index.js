let customers = [
            { id: 'CUS-01', name: 'James Smith', email: 'james@example.com', company: 'TechCorp', status: 'Active' },
            { id: 'CUS-02', name: 'Mary Johnson', email: 'mary@example.com', company: 'Innovate LLC', status: 'Inactive' },
            { id: 'CUS-03', name: 'John Williams', email: 'john@example.com', company: 'Global Solutions', status: 'Active' },
            { id: 'CUS-04', name: 'Patricia Brown', email: 'patricia@example.com', company: 'Alpha Systems', status: 'Active' },
            { id: 'CUS-05', name: 'Robert Jones', email: 'robert@example.com', company: 'Beta Inc', status: 'Inactive' },
            { id: 'CUS-06', name: 'Jennifer Garcia', email: 'jennifer@example.com', company: 'Omega Group', status: 'Active' },
            { id: 'CUS-07', name: 'Michael Miller', email: 'michael@example.com', company: 'NextGen', status: 'Active' },
            { id: 'CUS-08', name: 'Linda Davis', email: 'linda@example.com', company: 'CloudSync', status: 'Inactive' },
            { id: 'CUS-09', name: 'William Rodriguez', email: 'william@example.com', company: 'DataWorks', status: 'Active' },
            { id: 'CUS-10', name: 'Elizabeth Martinez', email: 'elizabeth@example.com', company: 'Peak Performance', status: 'Active' }
        ];

        let orders = [
            { id: 'ORD-01', customer: 'James Smith', date: '2023-10-01', amount: '150.00', status: 'Completed' },
            { id: 'ORD-02', customer: 'Mary Johnson', date: '2023-10-02', amount: '200.50', status: 'Pending' },
            { id: 'ORD-03', customer: 'John Williams', date: '2023-10-03', amount: '99.99', status: 'Processing' },
            { id: 'ORD-04', customer: 'Patricia Brown', date: '2023-10-04', amount: '450.00', status: 'Completed' },
            { id: 'ORD-05', customer: 'Robert Jones', date: '2023-10-05', amount: '120.00', status: 'Cancelled' },
            { id: 'ORD-06', customer: 'Jennifer Garcia', date: '2023-10-06', amount: '310.25', status: 'Processing' },
            { id: 'ORD-07', customer: 'Michael Miller', date: '2023-10-07', amount: '85.00', status: 'Pending' },
            { id: 'ORD-08', customer: 'Linda Davis', date: '2023-10-08', amount: '500.00', status: 'Completed' },
            { id: 'ORD-09', customer: 'William Rodriguez', date: '2023-10-09', amount: '75.50', status: 'Completed' },
            { id: 'ORD-10', customer: 'Elizabeth Martinez', date: '2023-10-10', amount: '1050.00', status: 'Processing' }
        ];

        // 2. GLOBAL VARIABLES
        let currentUser = { name: 'Admin User', email: 'admin@example.com', company: 'CloudCRM Inc' };
        ...
        function renderCustomers() {
            ...
            let searchValue = document.getElementById('search-customers').value.toLowerCase();
            ...
            for (let i = 0; i < customers.length; i++) {
                ...
                let matchesSearch = c.name.toLowerCase().includes(searchValue) || c.email.toLowerCase().includes(searchValue);
        ...
        function renderOrders() {
            ...
            let searchValue = document.getElementById('search-orders').value.toLowerCase();
            let filterValue = document.getElementById('filter-order-status').value;

            for (let i = 0; i < orders.length; i++) {
                let o = orders[i];
                
                let matchesSearch = o.id.toLowerCase().includes(searchValue) || o.customer.toLowerCase().includes(searchValue);
        ...
        function bindEvents() {
            ...
            document.getElementById('search-customers').addEventListener('input', renderCustomers);
            document.getElementById('filter-customer-status').addEventListener('change', renderCustomers);
